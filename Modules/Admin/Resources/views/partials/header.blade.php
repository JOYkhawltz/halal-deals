                ...
                <ul class="nav navbar-nav pull-right">
                    ...
                    <li class="dropdown dropdown-extended dropdown-notification" id="header_notification_bar">
                        <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                            <i class="icon-bell"></i>
                            @php
                            $models=App\Notification::where('notify_view_users','=','admin')->wherestatus('0')->orderBy('id', 'DESC')->get();
                    ...
                    <li class="dropdown dropdown-user">
                        ...
                        @endphp
                        <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                            <img alt="" class="img-circle admin_logo" src="{{ URL::asset('public/uploads/admin/profile_picture/thumb/' . $admin->image) }}" onerror="this.src='{{ URL::asset('public/backend/assets/pages/img/admin-default.jpg') }}'" />
                            <span class="username username-hide-on-mobile"> {{ ((isset($admin->full_name) && $admin->full_name !== NULL) ? $admin->full_name : "Not Given") }} </span>
                            <i class="fa fa-angle-down"></i>
                        </a>
