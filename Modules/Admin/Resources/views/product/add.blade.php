...
<div class="products-update">
    <div class="portlet light bordered">
        <div class="portlet-body form">
            <form method="post" class="form" action="{{route('admin-addproduct')}}" id="add-product-form" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="vendor_id" onchange="getType(this);">
