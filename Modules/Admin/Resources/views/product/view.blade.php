        ...
        <form class="form-horizontal">
            <div class="form-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <?php
                            $types = App\ProductType::where('id', $model->type)->first();
                            ?>
                            <div class="col-md-9">
                                <p class="form-control-static"> {{ (isset($types->name)) ? $types->name : "N/A" }} </p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label class="control-label col-md-3">Product subtype:</label>
                            <?php
                            $subtypes = App\ProductSubType::where('id', $model->sub_type)->first();
                            ?>
                            <div class="col-md-9">
                                <p class="form-control-static"> {{ (isset($subtypes->name)) ? $subtypes->name : "N/A" }} </p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <p class="form-control-static"><i class="fa fa-gbp" aria-hidden="true"></i>  {{ (isset($model->postage_cost) && $model->postage_cost != null) ? $model->postage_cost : 0.00 }} </p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="form-actions text-right">
                <a href="{{ Route('admin-updateproduct', ['id' => $model->prod_ID]) }}" class="btn green">
                    <i class="fa fa-pencil"></i> Edit
                </a>
                <a href="{{ Route('admin-products') }}" class="btn default">Back</a>
            </div>
        </form>
        <!-- END FORM-->
    </div>
