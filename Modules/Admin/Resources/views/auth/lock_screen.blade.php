...
<div class="page-lock">
    ...
    <div class="page-body">
        <img class="page-lock-img" src="{{ URL::asset('public/uploads/admin/profile_picture/preview/' . $model->image) }}" onerror="this.src='{{ URL::asset('public/backend/assets/pages/img/admin-default.jpg') }}'" alt="">
