    ...
    <div class="portlet-body ">
        <div class="clearfix">
            <div class="table-scrollable" style="border: none;">
                    <table class="ui celled table table-bordered datatable" cellspacing="0" width="100%" id="wallet-management">
                    <thead>
                        <tr>
                            <th>#</th>
                            <th>Vendor Name</th>
                            <th>Withdrawl Amount(<i class="fa fa-gbp" aria-hidden="true"></i>)</th>
