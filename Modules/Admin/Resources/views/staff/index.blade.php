...
@section('content')
<h3 class="page-title">Staffs
    <small>Manage all the staffs of the site from here</small>
</h3>
        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-green-haze bold uppercase">Staffs</span>
                </div>
                <div class="pull-right">
                    <a class="btn btn-success" href="{{ Route('admin-staff.create') }}"><i class="fa fa-plus" aria-hidden="true"></i> Create New</a>&nbsp;
                </div>
            </div>
            <div class="portlet-body">
                <div class="table-scrollable">
                    <table class="table table-striped table-bordered table-advance table-hover datatable" width="100%" id="admin-staff-table">
                        <thead>
                            <tr>
                                <th class="bold"> # </th>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header" style="background-color: #17C4BB;">
                ...
                <h4 class="modal-title" style="color: white;">Delete Staff</h4>
            </div>
