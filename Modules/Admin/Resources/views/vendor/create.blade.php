                ...
                <div class="form-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group {{ $errors->has('post_code') ? ' has-error' : '' }}">
                                ...
                                <input class="form-control" name="post_code" type="text"  value="{{ (old('post_code')!==NULL) ? old('post_code') : '' }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 {{ $errors->has('contact_no') ? ' has-error' : '' }}">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="contact_no" type="text"  value="{{ (old('contact_no')!==NULL) ? old('contact_no') : '' }}">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group {{ $errors->has('commission_type') ? ' has-error' : '' }}" onclick="checkcommissontype()">
                            ...
                            <input type="radio" name="commission_type" value="1" {{(old("commission_type") == 1)? "checked" : ""}}/>Commission
                            <input type="radio" name="commission_type" value="2" {{(old("commission_type") == 2)? "checked" : ""}}/>Commercial Rate
                            @if ($errors->has('commission_type'))
                            <div class="help-block">{{ $errors->first('commission_type') }}</div>
                            @endif
                        </div>
                    </div> 
                    <div class="col-sm-3 {{ $errors->has('commission_rate') ? ' has-error' : '' }}" id="commission_rate" style="display: none">
                        <div class="form-group">
                    ...
                    <div class="col-sm-3" id="additional_rate" style="display: none">
                        <div class="form-group">
                            <label for="usr"><strong>Additional Rate (%):</strong></label>
                            <input type="text" name="additional_rate" class="form-control" value="">
                        </div>
                    </div> 
                 </div>
                </div>
