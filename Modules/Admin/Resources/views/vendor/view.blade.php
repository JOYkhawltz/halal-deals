...
<!--            <tr>
            ...
            <tr>
                ...
                <td><i class="fa fa-usd"></i>{{ (isset($business->wallet_amount) && $business->wallet_amount !== NULL) ? $business->wallet_amount : "0.00" }}</td>
            </tr>
        </table>
        <form class="form-horizontal">
            <div class="form-actions text-right">
                <a href="{{ Route('vendor.edit', ['id' => base64_encode($model->id)]) }}" class="btn green">
