...
<h3 class="page-title">Vendors
    <small>Manage all the vendor of the site from here</small>
</h3>
        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                ...
                <div class="pull-right">
                    <a class="btn btn-success" href="{{ Route('vendor.create') }}"><i class="fa fa-plus" aria-hidden="true"></i> Create New</a>&nbsp;
                </div>
            </div>
            <div class="portlet-body">
                <div class="table-scrollable">
                    <table class="table table-striped table-bordered table-advance table-hover datatable" width="100%" id="vendor-table">
                        <thead>
                            <tr>
                                <th class="bold"> # </th>
