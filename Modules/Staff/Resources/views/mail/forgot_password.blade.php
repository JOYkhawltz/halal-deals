                    ...
                    <tbody><tr>
                            <td valign="top" style="border-collapse:collapse">
                                <div style="color:#808080;font-family:Arial;font-size:14px;line-height:150%;text-align:left" align="left">
                                    ...
                                    <div style="color:#808080;font-family:Arial;font-size:14px;line-height:150%;margin:5px 2px;text-align:left" align="left">
                                        <p><strong><span style="color:#B22222"><span style="font-size:18px"><span style="font-family:arial,helvetica,sans-serif">Hello</span>&nbsp;{{ $model->name }},</span></span></strong></p>
                                        <p><span style="font-size:14px">Your password regenerated successfully.</span></p>
                                        <p><span style="font-size:14px">Your new password is&nbsp;<span style="color:#000000"><strong>{{ $new_password }}</strong></span></span></p>
                                    </div>
                                    <div style="color:#808080;font-family:Arial;font-size:14px;line-height:150%;margin:5px 2px;text-align:left" align="left">
                                    </div>
                                    <div style="color:#808080;font-family:Arial;font-size:14px;line-height:150%;margin:5px 2px;text-align:left" align="left">
