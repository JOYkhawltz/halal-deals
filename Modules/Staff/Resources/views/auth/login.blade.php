@extends('staff::layouts.login')
@section('content')
<div class="login-content">
    <h1>{{ env('APP_NAME', 'Laravel') }} Staff Login</h1>
    <p> Lorem ipsum dolor sit amet, coectetuer adipiscing elit sed diam nonummy et nibh euismod aliquam erat volutpat. Lorem ipsum dolor sit amet, coectetuer adipiscing. </p>
    <form id="admin-login-form" class="login-form" action="{{ Route('staff-login') }}" method="POST">
        ...
        <div class="row">
            <div class="col-xs-6">
                ...
                if (isset($_COOKIE['staff_email']) && $_COOKIE['staff_email'] !== NULL) {
                    echo $_COOKIE['staff_email'];
                }
                ?>" required/> </div>
            <div class="col-xs-6">
                ...
                if (isset($_COOKIE['staff_password']) && $_COOKIE['staff_password'] !== NULL) {
                    echo $_COOKIE['staff_password'];
                }
                ?>" required/> </div>
        </div>
        <div class="row">
            <div class="col-sm-4">
                <div class="rem-password">
                    <p>Remember Me
                        ...
                        if (isset($_COOKIE['staff_email']) && $_COOKIE['staff_password'] !== NULL) {
