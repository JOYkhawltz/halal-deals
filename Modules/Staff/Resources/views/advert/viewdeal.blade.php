...
@section('breadcrumb')
<li> <a href="{{ Route('staff-deal-adverts') }}">Adverts</a></li>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <p class="form-control-static"><i class="fa fa-gbp" aria-hidden="true"></i>{{ (isset($model->cost_price) && $model->cost_price !==NULL) ? $model->cost_price :0.00 }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <p class="form-control-static"><i class="fa fa-gbp" aria-hidden="true"></i>{{ (isset($model->hd_price) && $model->hd_price !==NULL) ? $model->hd_price :0.00 }} </p>
                            </div>
                        </div>
                    </div>
                </div>
<!--                @if($model->date_start!==NULL)
            ...
            <div class="form-actions text-right">
                <a href="{{ Route('staff-deal-adverts') }}" class="btn default">Back</a>
            </div>
        </form>
        <!-- END FORM-->
    </div>
