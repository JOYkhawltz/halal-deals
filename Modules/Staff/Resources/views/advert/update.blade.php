...
<li> <a href="{{ Route('staff-viewadvert', ['id' => $model->advert_ID]) }}">{{ $model->title}}</a></li>
        ...
        <div class="row">
            <div class="col-md-10 col-sm-9">
                <div class="dash-right-sec">
                    ...
                    <form method="post" class="form" action="{{route('staff-post-editadvert')}}" id="add-product-advert-form" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
