...
<div class="portlet box blue-hoki">
    <div class="portlet-title">
        ...
        <div class="pull-right"><a href="{{route('staff-addadvert')}}" class="btn btn-success" style="position: relative; top: 3px;"><i class="fa fa-plus"></i> Add New</a></div>
    </div>
    <div class="portlet-body ">
        <div class="clearfix">
            <div class="table-scrollable" style="border: none;">
                <table class="ui celled table table-bordered datatable" cellspacing="0" width="100%" id="advert-management">
                    <thead>
                        <tr>
                                    <th>ID</th>
                                    <th>Advert Type</th>
