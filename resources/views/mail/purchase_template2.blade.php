                                            ...
                                            <tbody>
                                                <tr>
                                                    <td style="width:600px;color:rgb(85,85,85);line-height:1.4em;font-size:12px;padding:0px;text-align:left">
                                                        <h1 style="font-size: 16px;font-weight: normal;margin-top: 3px;margin-bottom: 7px;">Hii <span style="font-size: 15px;font-weight: bold;margin-bottom: 10px;color:#333;">{{$business->first_name}} {{$business->last_name}}</span></h1>
                                                ...
                                                <tr>
                                                    <td style="width:600px;color:rgb(85,85,85);line-height:1.4em;font-size:12px;padding:0px;text-align:left">
                                                        <h1 style="font-size: 16px;font-weight: normal;margin-top: 3px;margin-bottom: 7px;">Here are the details of {{$user->first_name}} {{$user->last_name}} order:</h1>
                                    ...
                                    <td style="padding:20px 30px 10px 30px;vertical-align:top">
                                        <table cellpadding="0" cellspacing="0" width="100%">
                                            <tbody>
                                                <tr>
                                                    <td style="width:600px;color:rgb(85,85,85);line-height:1.4em;font-size:12px;padding:0px;text-align:left">
                                                        <h1 style="font-size: 18px;font-weight: bold;margin-bottom:10px;color: #3a5168;">This is deal</h1>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="height: auto;background-color: #fff;padding: 5px 15px;">
                                                        <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td style="width:600px;color:rgb(85,85,85);line-height:1.4em;font-size:12px;padding:0px;text-align:left">
                                                                        <h1 style="font-size: 18px;font-weight: bold;margin-bottom:10px;color: #3a5168;">Voucher Codes:</h1>
                                                                    </td>
                                                                </tr>
                                                                
                                                                <?php
                                                                $voucher_ids = App\VoucherDetail::where('order_id', '=', $order->id)->where('bus_ID',$bus_ID)->get();
                                                                ?>
