                ...
                <div class="product-list-tbl-wrap">
                    <div class="row border-btm">
                        ...
                        <div class="col-sm-6 text-right pt-3 pr-4">
                            <a href="{{route('add-advert')}}" class="deflt-btn"><i class="fa fa-plus"></i> Add Advert</a>
                        </div>
                    </div>
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>${{number_format($advert->cost_price,2)}}</td>
                                    <td>${{number_format($advert->hd_price,2)}}</td>                                    
                                    ...
                                    <td>{{(isset($advert->voucher_expiry))?$advert->voucher_expiry.'days' :'Not Applicable'}}</td>
                                    <td>
                                        @if($advert->status==='0')
