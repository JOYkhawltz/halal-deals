                                    ...
                                    <ul class="feture-line">
                                        <li class="clearfix">
                                            <i class="fa fa-map-marker" aria-hidden="true"></i> <a href="javascript:void(0);">
                                                {{($bus_desc->address1)?$bus_desc->address1:''}}</br>
                                                {{($bus_desc->address2)?$bus_desc->address2:''}}</br>
                                                {{($bus_desc->town)?$bus_desc->town.','. $bus_desc->city:''}}</br>
                                                {{($bus_desc->website)?$bus_desc->website:''}}
                                        </a>
                                        </li>
                                        <li class="clearfix">
