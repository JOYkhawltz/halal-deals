                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group text-right">
                                    <label><input type="radio" name="type_id" class="signup-business-type" value="3" checked> Business Manager</label>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group text-left">
                                    <label><input type="radio" name="type_id" class="signup-business-type" value="4"> Customer</label>
                                </div>
                            </div>
                        </div>
                        <div class="help-block" id="error-type_id"></div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
